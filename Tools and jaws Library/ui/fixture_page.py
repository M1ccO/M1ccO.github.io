...
import ui.fixture_page_support.crud_actions as _crud
import ui.fixture_page_support.detail_visibility as _detail_vis
import ui.fixture_page_support.retranslate_page as _retranslate
import ui.fixture_page_support.selection_helpers as _sel
from ui.fixture_page_support.selection_signal_handlers import (
...
class FixturePage(CatalogPageBase):
    ...
    def __init__(
        ...
        super().__init__(parent=parent, item_service=fixture_service, translate=self._translate)
    ...
    def _perform_initial_load(self) -> None:
        ...
        from ui.fixture_page_support.detached_preview import warmup_preview_engine
    ...
    def create_delegate(self):
        return FixtureCatalogDelegate(parent=getattr(self, 'list_view', None), translate=self._t)
    ...
    def apply_filters(self, filters: dict) -> list[dict]:
        ...
        fixture_type = str(filters.get('fixture_type') or 'all').strip().lower()

        fixtures = self.fixture_service.list_fixtures(
    ...
    def _catalog_item_dict(self, fixture: dict) -> dict:
        ...
        return {
            ...
            'clamping_diameter_text': fixture.get('clamping_diameter_text', ''),
            'clamping_length': fixture.get('clamping_length', ''),
            'used_in_work': fixture.get('used_in_work', ''),
            'turning_washer': fixture.get('turning_washer', ''),
            'notes': fixture.get('notes', ''),
            'stl_path': fixture.get('stl_path', ''),
            'measurement_overlays': fixture.get('measurement_overlays', []),
            'preview_plane': fixture.get('preview_plane', 'XZ'),
            'preview_rot_x': fixture.get('preview_rot_x', 0),
            'preview_rot_y': fixture.get('preview_rot_y', 0),
            'preview_rot_z': fixture.get('preview_rot_z', 0),
            'preview_selected_part': fixture.get('preview_selected_part', -1),
            'preview_selected_parts': fixture.get('preview_selected_parts', []),
            'preview_transform_mode': fixture.get('preview_transform_mode', 'translate'),
            'preview_fine_transform': fixture.get('preview_fine_transform', False),
            '_raw': fixture,
        }
    ...
    def _on_item_selected_internal(self, fixture_id: str, _uid: int) -> None:
        _on_item_selected_internal_impl(self, fixture_id, _uid)

    def _on_item_deleted_internal(self, fixture_id: str) -> None:
        _on_item_deleted_internal_impl(self, fixture_id)
    ...
    def _nav_mode_title(self, mode: str) -> str:
        mapping = {
            'all': self._t('tool_library.nav.all_fixtures', 'All Fixtures'),
            'parts': self._t('tool_library.nav.fixture_parts', 'Parts'),
            'assemblies': self._t('tool_library.nav.fixture_assemblies', 'Assemblies'),
        }
    ...
    def set_module_switch_target(self, target: str) -> None:
        ...
        if target_text == 'TOOLS':
            display = self._t('tool_library.module.tools', 'TOOLS')
        elif target_text == 'FIXTURES':
            display = self._t('tool_library.module.fixtures', 'FIXTURES')
        else:
            display = self._t('tool_library.module.jaws', 'JAWS')
    ...
    def populate_details(self, fixture) -> None:
        populate_detail_panel(self, fixture)
    ...
    def _load_preview_content(self, viewer: StlPreviewWidget, fixture: dict, *, label: str | None = None) -> bool:
        return load_preview_content(self, viewer, fixture, label=label)
    ...
    def _apply_detached_measurement_state(self, fixture: dict) -> None:
        apply_detached_measurement_state(self, fixture)
