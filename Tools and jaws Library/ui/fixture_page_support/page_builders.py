...
from ui.fixture_page_support.catalog_list_widgets import FixtureCatalogListView
from ui.fixture_page_support.bottom_bars_builder import build_bottom_bars
from ui.fixture_page_support.selector_actions import update_selector_remove_button
from ui.fixture_page_support.selector_widgets import FixtureAssignmentSlot, SelectorRemoveDropButton
from ui.fixture_page_support.topbar_builder import build_filter_toolbar
...
def build_fixture_page_layout(page) -> None:
    ...
    if page.show_sidebar:
        ...
        side_title = QLabel(page._t('jaw_library.section.views', 'Fixture Views'))
...
def _build_selector_card(page) -> QFrame:
    ...
    (
        ...
        title_text=page._t('jaw_library.selector.header_title', 'Fixture Selector'),
        left_badge_text='SP1',
        right_badge_text=page._t('tool_library.selector.fixtures', 'Fixtures'),
    )
    ...
    from ui.fixture_page_support.selector_actions import on_selector_toggle_clicked
    ...
    page.selector_hint_label = build_selector_hint_label(
        text=page._t('tool_library.selector.jaw_hint', 'Drag fixtures from the catalog to SP1 or SP2.'),
        multiline=True,
    )
    selector_layout.addWidget(page.selector_hint_label, 0)

    page.selector_sp1_slot = FixtureAssignmentSlot(
        'main',
        page._t('jaw_library.selector.sp1_slot', 'SP1 fixture'),
        translate=page._t,
    )
    page.selector_sp2_slot = FixtureAssignmentSlot(
        'sub',
        page._t('jaw_library.selector.sp2_slot', 'SP2 fixture'),
        translate=page._t,
    )
