...
class _OrderedToolList(QWidget):
    ...
    def __init__(
        ...
        self.move_up_btn = QPushButton(self._t("work_editor.tools.move_up", "\u25B2 Up"))
        self.move_down_btn = QPushButton(self._t("work_editor.tools.move_down", "\u25BC Down"))
        self.remove_btn = QPushButton(self._t("work_editor.tools.remove", "Remove"))
        self.remove_btn.setProperty("secondaryAction", True)
