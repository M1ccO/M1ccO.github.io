...
from ui.widgets.common import BorderOnlyComboItemDelegate, clear_focused_dropdown_on_outside_click
...
class AddEditToolDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        style_icon_action_button(self.add_part_btn, TOOL_ICONS_DIR / 'select.svg', 'Add part')
        style_icon_action_button(self.remove_part_btn, TOOL_ICONS_DIR / 'delete.svg', 'Remove selected part', danger=True)
        self.part_up_btn = QPushButton()
        self.part_down_btn = QPushButton()
        style_move_arrow_button(self.part_up_btn, '▲', 'Move selected row up')
        style_move_arrow_button(self.part_down_btn, '▼', 'Move selected row down')
        ...
        style_icon_action_button(self.add_model_btn, TOOL_ICONS_DIR / 'select.svg', 'Add model')
        style_icon_action_button(self.remove_model_btn, TOOL_ICONS_DIR / 'delete.svg', 'Remove selected model', danger=True)
        self.model_up_btn = QPushButton()
        self.model_down_btn = QPushButton()
        style_move_arrow_button(self.model_up_btn, '▲', 'Move selected row up')
        style_move_arrow_button(self.model_down_btn, '▼', 'Move selected row down')
